...
public abstract class BaseTest {
    protected static Card R7 = new Card(7, RED);
    protected static Card R6 = new Card(6, RED);
    protected static Card R5 = new Card(5, RED);
    protected static Card R4 = new Card(4, RED);
    protected static Card R3 = new Card(3, RED);
    protected static Card R2 = new Card(2, RED);
    protected static Card R1 = new Card(1, RED);
